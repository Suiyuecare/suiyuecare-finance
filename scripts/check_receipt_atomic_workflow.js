...
create table public.ledger_entries(entry_date date,description text,entity_id text,department_code text,debit numeric,credit numeric,account_code text,account_name text,reference_no text,posting_key text unique,source_type text,source_id text,source_no text,tenant_id uuid,data_environment text,voided_at timestamptz);
