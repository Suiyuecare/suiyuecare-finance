...
declare revenue_repair_installed boolean:=false;hr_bridge_installed boolean:=false;ar_scope_installed boolean:=false;p record;denied boolean:=false;
begin
 ...
 if p.oid is null or md5(p.prosrc)<>(case when revenue_repair_installed then 'cec3d2e9b694c30e189aca9b1f2431a0' when hr_bridge_installed then '7734154b2b22e212c5dc0774cd4f7a06' else '84043dbdd33bd3e4152f61727e25b202' end) or not p.prosecdef or p.provolatile<>'s' or pg_get_userbyid(p.proowner)<>'postgres'
