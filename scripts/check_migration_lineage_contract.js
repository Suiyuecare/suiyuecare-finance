...
check('approval search is the exact final suffix',APPROVAL_SEARCH_MIGRATIONS.join(',')==='20260914091205' && migrations.slice(-APPROVAL_SEARCH_MIGRATIONS.length).join(',')==='20260914091205_finance_approval_search_projection_v1.sql');
