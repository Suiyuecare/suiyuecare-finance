...
check('approval search remains the exact reviewed predecessor',APPROVAL_SEARCH_MIGRATIONS.join(',')==='20260914091205' && migrations.slice(-2,-1).join(',')==='20260914091205_finance_approval_search_projection_v1.sql');
check('history summary is the exact final suffix',HISTORY_SUMMARY_MIGRATIONS.join(',')==='20260915050313' && migrations.slice(-HISTORY_SUMMARY_MIGRATIONS.length).join(',')==='20260915050313_finance_approval_history_summary_v1.sql');
