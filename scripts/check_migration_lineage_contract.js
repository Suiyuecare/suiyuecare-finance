...
check('approval search remains the exact reviewed predecessor',APPROVAL_SEARCH_MIGRATIONS.join(',')==='20260914091205' && migrations.slice(-3-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length),-2-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length)).join(',')==='20260914091205_finance_approval_search_projection_v1.sql');
check('history summary remains the exact reviewed predecessor',HISTORY_SUMMARY_MIGRATIONS.join(',')==='20260915050313' && migrations.slice(-2-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length),-1-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length)).join(',')==='20260915050313_finance_approval_history_summary_v1.sql');
check('invoice read scope is the exact predecessor of HR bridge',INVOICE_READ_SCOPE_MIGRATIONS.join(',')==='20260915080928' && migrations.slice(-1-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length),-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length)).join(',')==='20260915080928_finance_invoice_select_accounting_initplan_v1.sql');
check('AR read scope is the exact reviewed dependency',AR_READ_SCOPE_MIGRATIONS.join(',')==='20260922072737' && migrations.slice(-2-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length),-1-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length)).join(',')==='20260922072737_finance_ar_verified_accounting_scope_v1.sql');
check('HR bridge is the exact audit security predecessor',HR_BRIDGE_MIGRATIONS.join(',')==='20260922072109,20260922072737,20260922075604' && migrations.slice(-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length),-(AUDIT_SECURITY_MIGRATIONS.length+HR_DIRECTORY_EXPORT_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length)).join(',')==='20260922072109_finance_hr_private_bridge_v1.sql,20260922072737_finance_ar_verified_accounting_scope_v1.sql,20260922075604_finance_hr_voucher_posting_v1.sql');
check('audit security is the exact predecessor of the adopted HR directory migration',
  AUDIT_SECURITY_MIGRATIONS.join(',')==='20260922133752'
    && migrations.slice(-HR_DIRECTORY_EXPORT_MIGRATIONS.length-AUDIT_SECURITY_MIGRATIONS.length-(REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length),-HR_DIRECTORY_EXPORT_MIGRATIONS.length-(REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length)).join(',')
...
check('HR directory migration is an exact source recovery from the immutable production ledger',
  HR_DIRECTORY_EXPORT_MIGRATIONS.join(',')==='20260924043205'
    && migrations.slice(-HR_DIRECTORY_EXPORT_MIGRATIONS.length-(REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length),-(REVENUE_REPAIR_MIGRATIONS.length+OPERATIONAL_STABILITY_MIGRATIONS.length)).join(',')
...
check('revenue repair is the exact predecessor of operational stability',REVENUE_REPAIR_MIGRATIONS.join(',')==='20260924074010'&&migrations.slice(-OPERATIONAL_STABILITY_MIGRATIONS.length-REVENUE_REPAIR_MIGRATIONS.length,-OPERATIONAL_STABILITY_MIGRATIONS.length).join(',')==='20260924074010_finance_e8_g1101_home_care_revenue_repair_v1.sql');
check('operational stability is the exact final suffix',OPERATIONAL_STABILITY_MIGRATIONS.join(',')==='20260924155142'&&migrations.slice(-OPERATIONAL_STABILITY_MIGRATIONS.length).join(',')==='20260924155142_finance_operational_stability_v1.sql');
