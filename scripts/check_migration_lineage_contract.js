...
check('route authority and all reviewed production hotfixes are the exact lineage suffix',
  releaseIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 8
    && adoptedRepairIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 7
    && routeHotfixIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 6
    && statusHotfixIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 5
    && finalAccountantHotfixIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 4
    && cashierRepairIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 3
    && cashierSelfDisbursementIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 2
    && humanAccountingIndex === migrations.length - HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length) - EMPLOYEE_RELIABILITY_MIGRATIONS.length - AUDIT_READINESS_MIGRATIONS.length - REPORTING_INTEGRITY_MIGRATIONS.length - AMOUNT_SEARCH_MIGRATIONS.length - REPORT_MIGRATIONS.length - UTILITY_MIGRATIONS.length - CASE_MIGRATIONS.length - AUDIT_MIGRATIONS.length - 1,
  migrations[migrations.length - 1] || '(none)');
check('audited batch is the exact ordered predecessor of cases and utility',migrations.slice(-AUDIT_MIGRATIONS.length-CASE_MIGRATIONS.length-UTILITY_MIGRATIONS.length-REPORT_MIGRATIONS.length-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-CASE_MIGRATIONS.length-UTILITY_MIGRATIONS.length-REPORT_MIGRATIONS.length-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length).map(name=>name.slice(0,14)).join(',')===AUDIT_MIGRATIONS.join(','));
check('database cases are the exact ordered predecessor of utility',migrations.slice(-CASE_MIGRATIONS.length-UTILITY_MIGRATIONS.length-REPORT_MIGRATIONS.length-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-UTILITY_MIGRATIONS.length-REPORT_MIGRATIONS.length-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length).map(name=>name.slice(0,14)).join(',')===CASE_MIGRATIONS.join(','));
check('utility tax is the exact ordered predecessor of reports',migrations.slice(-UTILITY_MIGRATIONS.length-REPORT_MIGRATIONS.length-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-REPORT_MIGRATIONS.length-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length).map(name=>name.slice(0,14)).join(',')===UTILITY_MIGRATIONS.join(','));
check('financial reports are the exact predecessor of amount search',migrations.slice(-REPORT_MIGRATIONS.length-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length).map(name=>name.slice(0,14)).join(',')===REPORT_MIGRATIONS.join(','));
check('amount search is the exact predecessor of reporting integrity',migrations.slice(-AMOUNT_SEARCH_MIGRATIONS.length-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length).map(name=>name.slice(0,14)).join(',')===AMOUNT_SEARCH_MIGRATIONS.join(','));
check('reporting integrity is the exact ordered predecessor of audit readiness',migrations.slice(-REPORTING_INTEGRITY_MIGRATIONS.length-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length).map(name=>name.slice(0,14)).join(',')===REPORTING_INTEGRITY_MIGRATIONS.join(','));
check('audit readiness is the exact fixed predecessor of employee reliability',AUDIT_READINESS_MIGRATIONS.join(',')==='20260911151054' && migrations.slice(-AUDIT_READINESS_MIGRATIONS.length-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length).join(',')==='20260911151054_finance_audit_readiness_v1.sql');
check('employee reliability is the exact fixed predecessor of history performance',EMPLOYEE_RELIABILITY_MIGRATIONS.join(',')==='20260912145849' && migrations.slice(-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)-EMPLOYEE_RELIABILITY_MIGRATIONS.length,-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260912145849_finance_employee_payment_concerns_v1.sql');
check('history performance is the exact fixed predecessor of source paging',HISTORY_PERFORMANCE_MIGRATIONS.join(',')==='20260912164807' && migrations.slice(-HISTORY_PERFORMANCE_MIGRATIONS.length-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260912164807_finance_approval_history_page_first_v1.sql');
check('statement source paging is the exact fixed predecessor of AR mapping',
  READ_LATENCY_MIGRATIONS.join(',') === '20260913042629'
    && migrations.slice(-READ_LATENCY_MIGRATIONS.length-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')
      === '20260913042629_finance_statement_source_page_v1.sql');
check('AR mapping is the exact fixed predecessor of audit remediation',AR_MAPPING_MIGRATIONS.join(',')==='20260913061745' && migrations.slice(-AR_MAPPING_MIGRATIONS.length-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260913061745_finance_ar_mapping_set_based_v1.sql');
check('audit remediation is the exact ordered predecessor of approval search',AUDIT_REMEDIATION_MIGRATIONS.join(',')==='20260914001246,20260914001252' && migrations.slice(-AUDIT_REMEDIATION_MIGRATIONS.length-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-APPROVAL_SEARCH_MIGRATIONS.length-HISTORY_SUMMARY_MIGRATIONS.length-INVOICE_READ_SCOPE_MIGRATIONS.length-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260914001246_finance_dashboard_scope_integrity_v1.sql,20260914001252_finance_google_projection_identity_v3.sql');
...
check('approval search remains the exact reviewed predecessor',APPROVAL_SEARCH_MIGRATIONS.join(',')==='20260914091205' && migrations.slice(-3-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-2-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260914091205_finance_approval_search_projection_v1.sql');
check('history summary remains the exact reviewed predecessor',HISTORY_SUMMARY_MIGRATIONS.join(',')==='20260915050313' && migrations.slice(-2-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-1-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260915050313_finance_approval_history_summary_v1.sql');
check('invoice read scope is the exact predecessor of HR bridge',INVOICE_READ_SCOPE_MIGRATIONS.join(',')==='20260915080928' && migrations.slice(-1-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260915080928_finance_invoice_select_accounting_initplan_v1.sql');
check('AR read scope is the exact reviewed dependency',AR_READ_SCOPE_MIGRATIONS.join(',')==='20260922072737' && migrations.slice(-2-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-1-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260922072737_finance_ar_verified_accounting_scope_v1.sql');
check('HR bridge is the exact audit security predecessor',HR_BRIDGE_MIGRATIONS.join(',')==='20260922072109,20260922072737,20260922075604' && migrations.slice(-HR_BRIDGE_MIGRATIONS.length-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length),-(AUDIT_SECURITY_MIGRATIONS.length+REVENUE_REPAIR_MIGRATIONS.length)).join(',')==='20260922072109_finance_hr_private_bridge_v1.sql,20260922072737_finance_ar_verified_accounting_scope_v1.sql,20260922075604_finance_hr_voucher_posting_v1.sql');
check('audit security is the exact revenue repair predecessor',AUDIT_SECURITY_MIGRATIONS.join(',')==='20260922133752'&&migrations.slice(-AUDIT_SECURITY_MIGRATIONS.length-REVENUE_REPAIR_MIGRATIONS.length,-REVENUE_REPAIR_MIGRATIONS.length).join(',')==='20260922133752_finance_document_identity_attachment_scope_v1.sql');
