...
declare hr_bridge_installed boolean:=false;p record;v_source text;v_query text;t uuid;env text;company text;result jsonb;expected record;denied boolean;
