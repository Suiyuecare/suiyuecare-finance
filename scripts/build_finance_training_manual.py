...
OUT = ROOT / "docs" / "歲悅會計系統教育訓練手冊.docx"
...
def build_doc():
    ...
    add_table(
        ...
        [
            ...
            ["人資", "福利與人事費用相關審核", "福利申請、人事費用申請、簽核管理"],
    ...
    doc.add_heading("三、登入與模組選擇", level=1)
    add_numbers(
        doc,
        [
    ...
    add_table(
        ...
        [
            ...
            ["福利申請", "依福利項目上傳對應證明文件；行政部門主任後會加上人資審核。"],
