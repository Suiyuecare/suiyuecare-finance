...
(async()=>{
 ...
 var h=approvalHistoryRuntimeForCurrentUser();h.status='ready';h.identity=approvalFastBootstrapIdentity();h.total=1;h.allTotal=1;h.page=1;h.query='';h.updatedAt='2026-09-12T02:00:00Z';h.items=[{kind:'req',raw:window.__navRow,historyTrusted:true,historyKey:'req:navigation-history',historyPersonallyActed:true,historyParticipationLabel:'本人已處理',historyLastParticipatedAt:'2026-09-12T01:00:00Z',historyParticipantSteps:window.__navRow.steps}];
