...
CREATE OR REPLACE FUNCTION public.hris_list_attendance_punches(input_user_id uuid, input_email text, input_role text, input_limit integer DEFAULT 200)
...
CREATE OR REPLACE FUNCTION public.hris_review_attendance_punch(input_user_id uuid, input_email text, input_role text, input_punch_id uuid, input_review_status text)
 RETURNS attendance_punches
 LANGUAGE plpgsql
 SECURITY DEFINER
 SET search_path TO 'public'
