...
const EXPECTED_RELEASE_SCRIPTS = Object.freeze({
  ...
  'test:dashboard-readiness': "node scripts/check_dashboard_financial_sources.cjs && node scripts/check_dashboard_aggregate_loading.cjs && node scripts/check_reporting_profile_readiness.cjs",
