...
const LEGACY_SCHEMA_SQL_BASELINE = Object.freeze({
  ...
  'supabase/module_finance_production_schema.sql': '51f97d3b65ad72d0b4758f7ffb46bab18a4de606ecb8793b8f0f75b1bcc932ee',
  ...
  'supabase/reactivate_legacy_test_accounts_for_storage_20260522.sql': '0c93c897af0b90da68970cea4e767861ecb663bac4a1f79691cfb88fcac87640',
...
const REQUIRED_RELEASE_FILES = Object.freeze([
  ...
  'scripts/check_hr_accounting_read_privacy_browser.mjs',
  'docs/FINANCE_HR_ACCOUNTING_READ_PRIVACY.md',
  'scripts/check_hr_accounting_read_privacy.cjs',
  'scripts/test_hr_voucher_posting_concurrency.mjs',
  'scripts/test_hr_voucher_posting.mjs',
  'scripts/fixtures/finance_hr_voucher_baseline_20260922.json',
  'scripts/test_hr_private_bridge.mjs',
  'scripts/test_hr_bridge_release_batch.mjs',
  'scripts/test_audit_security_release_batch.mjs',
  'scripts/check_finance_ui_interaction_browser.cjs',
  'scripts/check_audit_export_integrity.cjs',
  'scripts/test_finance_document_access_v1.cjs',
  'scripts/fixtures/finance_attachment_claim_dependencies_20260922.json',
  'scripts/fixtures/finance_attachment_write_scope_20260922.json',
  'scripts/fixtures/finance_document_access_baseline_20260922.json',
  'scripts/check_audit_release_pin_compatibility.cjs',
  'scripts/check_income_submission_recovery.cjs',
  'scripts/check_receipt_result_recovery.cjs',
  'docs/finance-audit-security-release-20260922.md',
  'docs/audits/2026-09-22-document-access-remediation.md',
  'docs/FINANCE_AUDIT_REMEDIATION_20260922.md',
  ...
  'scripts/finance_audit_security_canary.sql',
  'scripts/finance_revenue_repair_fingerprint.sql',
  'scripts/finance_revenue_repair_postflight.sql',
  'scripts/finance_revenue_repair_canary.sql',
  'scripts/finance_operational_stability_postflight.sql',
  'scripts/finance_operational_stability_canary.sql',
  'scripts/check_operational_stability_migration.cjs',
  ...
  'supabase/migrations/20260924155142_finance_operational_stability_v1.sql',
  ...
  'scripts/fixtures/finance_invoice_approval_helpers_20260924.sql',
  'docs/finance-revenue-repair-release-20260924.md',
  'docs/finance-dashboard-revenue-remediation-20260924.md',
  'scripts/check_dashboard_revenue_gap.cjs',
  'scripts/check_dashboard_department_overview.cjs',
  ...
  'scripts/check_workflow_simplification_contract.js',
  'scripts/test_expense_route_authority_v2.js',
  'scripts/check_incident_account_org_repair.js',
  'scripts/check_final_accountant_self_post_contract.js',
  'scripts/check_formal_cashier_self_disbursement_contract.js',
  'scripts/check_human_accounting_authority.js',
...
const EXPECTED_RELEASE_SCRIPTS = Object.freeze({
  ...
  'test:reporting-integrity': "node scripts/check_tax_source_integrity.cjs && node scripts/check_tax_source_runtime.cjs && node scripts/check_ar_reconciliation_scope.cjs && node scripts/check_ar_export_reconciliation_ui.cjs && node scripts/check_department_statement_export.cjs && node scripts/test_reporting_integrity_release_batch.mjs",
  ...
  'test:revenue-repair-release': "node scripts/check_home_care_revenue_repair.cjs && node scripts/check_dashboard_revenue_gap.cjs && node scripts/check_revenue_repair_migration_integration.cjs && node scripts/test_revenue_repair_release_batch.mjs",
  'test:operational-stability-release': 'node scripts/check_operational_stability_migration.cjs',
  'test:demo-password-retirement': 'node scripts/check_finance_demo_password_retirement.cjs',
  'test:dashboard-readiness': "node scripts/check_dashboard_department_overview.cjs && node scripts/check_dashboard_financial_sources.cjs && node scripts/check_dashboard_aggregate_loading.cjs && node scripts/check_reporting_profile_readiness.cjs",
  'test:dashboard-readiness-browser': "node scripts/check_dashboard_readiness_browser.cjs",
  'test:draft-readiness': "node scripts/check_draft_readiness.cjs && node scripts/check_draft_mutation_readiness.cjs",
  'test:draft-readiness-browser': "node scripts/check_draft_readiness_browser.cjs",
  ...
  'test:approval-search-20260914': "node scripts/check_approval_history_search.cjs && node scripts/check_approval_search_projection.cjs && node scripts/test_approval_search_release_batch.mjs",
  'test:history-summary': "node scripts/check_approval_history_summary_frontend.cjs && node scripts/check_approval_history_summary.cjs && node scripts/test_history_summary_release_batch.mjs",
  'test:history-summary-browser': "node scripts/check_approval_search_summary_browser.cjs",
  'test:history-summary-concurrency': "node scripts/check_approval_history_summary_concurrency.cjs",
  'test:ar-read-scope': "node scripts/check_ar_verified_accounting_scope.cjs && node scripts/test_ar_read_scope_release_batch.mjs",
  'test:invoice-read-scope': "node scripts/check_workflow_optional_reads.cjs && node scripts/check_invoice_select_initplan.cjs && node scripts/test_invoice_read_scope_release_batch.mjs",
  'test:hr-accounting-privacy': 'node scripts/check_hr_accounting_read_privacy.cjs',
  'test:hr-voucher-posting': 'node scripts/test_hr_voucher_posting.mjs',
  'test:hr-voucher-browser': 'HR_BRIDGE_BROWSER=1 node scripts/test_hr_voucher_posting.mjs',
  'test:hr-bridge': 'node scripts/test_hr_private_bridge.mjs',
  "test:audit-security": "node scripts/test_finance_document_access_v1.cjs && node scripts/check_audit_release_pin_compatibility.cjs && node scripts/check_audit_export_integrity.cjs && node scripts/check_income_submission_recovery.cjs && node scripts/check_receipt_result_recovery.cjs && node scripts/test_audit_security_release_batch.mjs",
