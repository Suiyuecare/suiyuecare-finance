...
const context={console,Map,Set,Intl,AbortController,setTimeout,clearTimeout,document:{getElementById:id=>elements[id],addEventListener(){}},FinanceManagementReportEngine:management};context.window=context;
