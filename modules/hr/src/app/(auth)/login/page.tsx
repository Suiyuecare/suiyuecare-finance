...
export default function LoginPage() {
  return (
    <main className="flex min-h-screen bg-[#eee7de] p-0 sm:p-4">
      <section className="suiyue-system-shell mx-auto grid min-h-screen w-full max-w-[1200px] overflow-hidden bg-[#fbfaf8] sm:min-h-[calc(100vh-2rem)] sm:rounded-[18px] md:grid-cols-[0.92fr_1.08fr]">
